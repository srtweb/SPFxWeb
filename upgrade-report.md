# Upgrade project D:\Learnings\SPFx\SPFx\SPFxWeb to v1.10.0
...
In file [src\webparts\createChannel\CreateChannelWebPart.ts](src\webparts\createChannel\CreateChannelWebPart.ts) update the code as follows:
...
File: [src\webparts\createChannel\CreateChannelWebPart.ts:4:1](src\webparts\createChannel\CreateChannelWebPart.ts)

### FN016004 Property pane property import change to @microsoft/sp-property-pane | Required

Refactor the code to import property pane property from the @microsoft/sp-property-pane npm package instead of the @microsoft/sp-webpart-base package

In file [src\webparts\createChannels\CreateChannelsWebPart.ts](src\webparts\createChannels\CreateChannelsWebPart.ts) update the code as follows:
...
File: [src\webparts\createChannels\CreateChannelsWebPart.ts:4:1](src\webparts\createChannels\CreateChannelsWebPart.ts)

### FN016004 Property pane property import change to @microsoft/sp-property-pane | Required

Refactor the code to import property pane property from the @microsoft/sp-property-pane npm package instead of the @microsoft/sp-webpart-base package

In file [src\webparts\createTeams\CreateTeamsWebPart.ts](src\webparts\createTeams\CreateTeamsWebPart.ts) update the code as follows:
...
File: [src\webparts\createTeams\CreateTeamsWebPart.ts:4:1](src\webparts\createTeams\CreateTeamsWebPart.ts)

### FN016004 Property pane property import change to @microsoft/sp-property-pane | Required

Refactor the code to import property pane property from the @microsoft/sp-property-pane npm package instead of the @microsoft/sp-webpart-base package

In file [src\webparts\myMails\MyMailsWebPart.ts](src\webparts\myMails\MyMailsWebPart.ts) update the code as follows:
...
File: [src\webparts\myMails\MyMailsWebPart.ts:4:1](src\webparts\myMails\MyMailsWebPart.ts)
...
#### [src\webparts\createChannel\CreateChannelWebPart.ts](src\webparts\createChannel\CreateChannelWebPart.ts)
...
#### [src\webparts\createChannels\CreateChannelsWebPart.ts](src\webparts\createChannels\CreateChannelsWebPart.ts)
...
#### [src\webparts\createTeams\CreateTeamsWebPart.ts](src\webparts\createTeams\CreateTeamsWebPart.ts)
...
#### [src\webparts\myMails\MyMailsWebPart.ts](src\webparts\myMails\MyMailsWebPart.ts)
